...
@Mod(modid = MultipartMod.modID, dependencies = MultipartMod.deps, acceptedMinecraftVersions = "[1.10]", modLanguage = "scala", certificateFingerprint = "f1850c39b2516232a2108a7bd84d1cb5df93b261")
object MultipartMod
{
    final val modID = "forgemultipartcbe"
    final val deps = "required-after:CodeChickenLib@[" + CodeChickenLib.version + ",)"
