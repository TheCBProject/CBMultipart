...
// */
////TODO, VoxelShapes are stored similar to how this is computed, we can probably be smarter about this now..
...
//        fill(i, part.getPartialOcclusionShape, part.allowCompleteOcclusion)
//    }
//
//    def fill(i: Int, boxes: lang.Iterable[VoxelShape], complete: Boolean) {
//        partial(i) = !complete
//        boxes.forEach(shape => fill(i + 1, VoxelShapeCache.getCuboid(shape)))
//    }
//
...
trait TPartialOcclusionPart {
     ...
     */
    def getPartialOcclusionShape: VoxelShape
