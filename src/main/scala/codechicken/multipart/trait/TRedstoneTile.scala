...
import codechicken.multipart.api.part.RedstoneInteractions._
...
import codechicken.multipart.api.part.{TEdgePart, TFacePart}

/**
 * Mixin trait implementation for IRedstonePart
 * Provides and overrides various redstone functions.
 */
@MultiPartTrait(classOf[IRedstonePart])
